#include "TauAnalysis/SVfitDevelopment/plugins/SVfitTauToMuInputAnalyzer.h"
...
SVfitTauToMuInputAnalyzer::SVfitTauToMuInputAnalyzer(const edm::ParameterSet& cfg)
...
SVfitTauToMuInputAnalyzer::~SVfitTauToMuInputAnalyzer()
{
  delete eventVertexFitAlgorithm_;
  delete decayVertexFitAlgorithm_;
}

void SVfitTauToMuInputAnalyzer::beginJob()
{
  if ( !edm::Service<DQMStore>().isAvailable() ) {
    throw cms::Exception("SVfitTauToMuInputAnalyzer") 
...
void SVfitTauToMuInputAnalyzer::analyze(const edm::Event& evt, const edm::EventSetup& es)
{
  ...
  if ( !trackBuilder ) {
    throw cms::Exception("SVfitTauToMuInputAnalyzer::analyze")
...
DEFINE_FWK_MODULE(SVfitTauToMuInputAnalyzer);

#ifndef TauAnalysis_SVfitDevelopment_SVfitTauToHadInputAnalyzer_h
#define TauAnalysis_SVfitDevelopment_SVfitTauToHadInputAnalyzer_h
...
class SVfitTauToHadInputAnalyzer : public edm::EDAnalyzer 
{
 public:
  // constructor 
  explicit SVfitTauToHadInputAnalyzer(const edm::ParameterSet&);
    
  // destructor
  ~SVfitTauToHadInputAnalyzer();

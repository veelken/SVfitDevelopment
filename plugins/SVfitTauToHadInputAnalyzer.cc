#include "TauAnalysis/SVfitDevelopment/plugins/SVfitTauToHadInputAnalyzer.h"
...
SVfitTauToHadInputAnalyzer::SVfitTauToHadInputAnalyzer(const edm::ParameterSet& cfg)
...
SVfitTauToHadInputAnalyzer::~SVfitTauToHadInputAnalyzer()
{
...
namespace
{
  ...
  //     to avoid dependency of TauAnalysis/SVfitDevelopment on TauAnalysis/Core package
...
void SVfitTauToHadInputAnalyzer::beginJob()
{
  if ( !edm::Service<DQMStore>().isAvailable() ) {
    throw cms::Exception("SVfitTauToHadInputAnalyzer") 
...
void SVfitTauToHadInputAnalyzer::analyze(const edm::Event& evt, const edm::EventSetup& es)
{
  ...
  if ( !trackBuilder ) {
    throw cms::Exception("SVfitTauToHadInputAnalyzer::analyze")
...
DEFINE_FWK_MODULE(SVfitTauToHadInputAnalyzer);

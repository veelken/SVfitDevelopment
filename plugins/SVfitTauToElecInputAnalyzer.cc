#include "TauAnalysis/SVfitDevelopment/plugins/SVfitTauToElecInputAnalyzer.h"
...
SVfitTauToElecInputAnalyzer::SVfitTauToElecInputAnalyzer(const edm::ParameterSet& cfg)
...
SVfitTauToElecInputAnalyzer::~SVfitTauToElecInputAnalyzer()
{
  delete eventVertexFitAlgorithm_;
  delete decayVertexFitAlgorithm_;
}

void SVfitTauToElecInputAnalyzer::beginJob()
{
  if ( !edm::Service<DQMStore>().isAvailable() ) {
    throw cms::Exception("SVfitTauToElecInputAnalyzer") 
...
void SVfitTauToElecInputAnalyzer::analyze(const edm::Event& evt, const edm::EventSetup& es)
{
  ...
  if ( !trackBuilder ) {
    throw cms::Exception("SVfitTauToElecInputAnalyzer::analyze")
...
DEFINE_FWK_MODULE(SVfitTauToElecInputAnalyzer);
